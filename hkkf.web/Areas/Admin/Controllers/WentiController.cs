...
namespace hkkf.web.Areas.Admin.Controllers
{
    ...
    [SmartAuthorize]
    [SmartMasterPage]
    public class WentiController : Controller
    {
        //
        // GET: /Admin/Wenti/
       ...
       public ActionResult WenTiIndex(QueryInfo queryInfo, int[] ids,string typeid, string shopid,string shopname, string NContent, int? wtTypeid, string subAction)
        {
           ...
           ViewBag.ShopName = shopname;
            ...
            var data = shopWenTiRepository.GetData(queryInfo, shopname, NContent, wtTypeid,null);
            return View(data);
        }
           ...
           if (shopid != null)
           {
            ...
            if (IsEdit == "1")
            {
                ...
                try
                {
                    ...
                    return RedirectToAction("WenTiIndex");
                }
